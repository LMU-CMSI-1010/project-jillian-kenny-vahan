...
class StartMenu:
    ...
    def __init__(self):
        self.display_surface = pygame.display.get_surface()
        self.background= pygame.image.load('../graphics/background/win.png').convert_alpha()
        self.width = 800
        self.height = 800
        self.space = 500
        self.padding = 100
...
#class WinMenu:
    ...
    #running =  True
    #GAME_FONT.render_to(screen, (40, 350), "Congrats on completing the level", (200, 0, 0))
    #GAME_FONT.render_to(screen, (40, 300), "Press space to continue", (200, 0, 0))
#pygame.display.flip()
#pygame.quit
