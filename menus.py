...
class StartMenu:
    ...
    def update(self):
        self.input()
        #text_surf=self.font.render('MARIO BROS 1',True,'Black')
...
screen = pygame.display.set_mode((800, 800))
GAME_FONT = pygame.freetype.Font("../font/FutilePro.ttf", 10)
running =  True
...
while running:
    ...
    GAME_FONT.render_to(screen, (40, 350), "WELCOME TO MARIO BROS 1! GET READY FOR A CHALLENGE ! YOU WILL GO THROUGH THE TOUGH TERRAIN TO TRY AND GET MARIO THE GOLD AND WIN.", (200, 0, 0))
    pygame.display.flip()
pygame.quit